...
function breakStatement(numero) {
  ...
  for(var i = 0; i < 10; i++){
    ...
    if(suma === i){
      ...
      arrayBreakStatement.push(suma);
    }
    if(arrayBreakStatement.length < 10){
    return "Se interrumpio la ejecucion";
  }else if(arrayBreakStatement.length === 10) {
    return arrayBreakStatement;
  }
}
}
...
function continueStatement(numero) {
  ...
  for(var i = 0; i < 10; i++){
    ...
    if(suma === i){
      ...
      suma = suma + 2;
      arrayCaramelos.push(suma);
    }
  }
  return arrayCaramelos;
}
